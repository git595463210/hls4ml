...
#ifndef NNET_RANDOMDROPOUT_STREAM_H_
#define NNET_RANDOMDROPOUT_STREAM_H_
...
void random_dropout(hls::stream<data_T> &data_stream, hls::stream<res_T> &res_stream) {
